...
class _ConsignerListState extends State<ConsignerList> {
  ...
  void initState() {
    textEditingController.text =
        context.read<ConsigneerBloc>().state.searchValue;
    super.initState();
  }
      ...
      children: [
        Padding(
            ...
            child: TextBox(
              ...
              onChanged: (value) =>
                  context.read<ConsigneerBloc>().add(Filter(value)),
              suffixMode: OverlayVisibilityMode.always,
              placeholder: "Buscar",
            )),
        BlocBuilder<ConsigneerBloc, ConsigneerState>(builder: (context, state) {
              ...
              trailing: Row(children: [
                IconButton(
                    ...
                    onPressed: widget.selecteds.isNotEmpty
                        ? null
                        : () {
                            context.read<ConsigneerBloc>().add(DeleteConsigner(
